...
INPUT_DIR = file.path( WORKING_DIR, "05_Output", "step1")

rmarkdown::render( input = file.path( SCRIPT_DIR, "SPlab_ILCYou_SecondaryAnalysis.Rmd"),
                   output_dir = OUTPUT_DIR,
                   output_file  = "SPlab_ILCYou_SecondaryAnalysis.html",
                   quiet = FALSE)
