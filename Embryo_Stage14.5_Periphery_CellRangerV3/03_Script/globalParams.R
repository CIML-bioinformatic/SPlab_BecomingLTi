...
GLOBAL_DESCRIPTION = "Becoming LTi - Embryo Stage14.5 Periphery - CellRanger V3"

SCIENTIFIC_GROUP = "SPlab"
SCIENTIFIC_PROJECT_NAME = "BecomingLTi"
EXPERIMENT_PROJECT_NAME = "Embryo_Stage14.5_Periphery_CellRangerV3"

SAMPLE_NAME = "Embryo_Stage14.5_Periphery"
SAMPLE_ID = "106310445"
