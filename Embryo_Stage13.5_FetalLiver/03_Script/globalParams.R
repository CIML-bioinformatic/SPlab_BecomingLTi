...
GLOBAL_DESCRIPTION = "Becoming LTi - Embryo Stage13.5 Fetal Liver"

SCIENTIFIC_GROUP = "SPlab"
SCIENTIFIC_PROJECT_NAME = "BecomingLTi"
EXPERIMENT_PROJECT_NAME = "Embryo_Stage13.5_FetalLiver"

SAMPLE_NAME = "Embryo_Stage13.5_FetalLiver"
SAMPLE_ID = "11230811"
