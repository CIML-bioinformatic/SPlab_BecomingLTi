...
GLOBAL_DESCRIPTION = "Becoming LTi - Embryo Stage14.5 Fetal Liver"

SCIENTIFIC_GROUP = "SPlab"
SCIENTIFIC_PROJECT_NAME = "BecomingLTi"
EXPERIMENT_PROJECT_NAME = "Embryo_Stage14.5_FetalLiver"

SAMPLE_NAME = "Embryo_Stage14.5_FetalLiver"
SAMPLE_ID = "11230812"
